...
//    std::cout << "AreaConverageBenchmarking" << std::endl;
    ...
    desc.add_options()
            ("help,h", "Help screen")
            ("j", po::value<string>(), "input json file")
            ("i", po::value<string>(), "input image file")
            ("o", po::value<string>(), "output image dir")
            ("m", po::value<int>(), "method number 1: MINTURN 2: HORIZONTAL 3: TRIANGULAR")
            ;
